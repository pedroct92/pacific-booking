...
public class BookingWorkers extends AbstractVerticle {
    ...
    @Autowired
    public BookingWorkers(BookingServiceProxy bookingServiceProxy) {
    ...
    public void start(Future<Void> startFuture) {
        new ServiceBinder(vertx)
                ...
                .completionHandler(ar -> {
                    if (ar.succeeded()) {
                        LOG.info("SpringWorker started - " + BookingServiceProxy.ADDRESS);
